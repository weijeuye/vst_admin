 ...
 */
@Controller
@RequestMapping("/selfTour/prod/product/trafficservice")
public class SelfTourTrafficServiceProductAction extends BaseActionSupport {
	/**
	 * 
	 */
	private static final long serialVersionUID = -6191883240752079057L;

	private static final Log LOG = LogFactory.getLog(SelfTourTrafficServiceProductAction.class);
...
//				}
		...
		return "/prod/selfTour/product/trafficservice/findProdGroupList";
	}
	...
	public String showSelectReProductList(Model model,Long prodProductId, Long categoryId){
		model.addAttribute("prodProductId", prodProductId);
		model.addAttribute("categoryId", categoryId);
		return "/prod/selfTour/product/trafficservice/showSelectReProductList";
	}
	...
	public String showProductMaintain(Model model, Long productId, String categoryName,Long categoryId,String isView,Long subCategoryId) throws BusinessException {
		...
		return "/prod/selfTour/product/trafficservice/showProductMaintain";
	}
