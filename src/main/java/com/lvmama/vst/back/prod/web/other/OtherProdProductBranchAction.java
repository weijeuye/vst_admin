...
@Controller
@RequestMapping("/other/prod/prodbranch")
public class OtherProdProductBranchAction extends BaseActionSupport {

	/**
	 * 
	 */
	private static final long serialVersionUID = 7983264228865300814L;
	...
	@Autowired
	private PetProdGoodsAdapter petProdGoodsAdapter;//1
	...
	@Autowired
	private BizBranchQueryService bizBranchQueryService;//2
	
	@SuppressWarnings("unchecked")
	@RequestMapping(value = "/findProductBranchList.do")
	public String findProductBranchList(Model model, Integer page, ProdProductBranch prodProductBranch, Long productId, Long categoryId, HttpServletRequest req) throws Exception {
		...
		List<ProdProductBranch> prodProductBranchList = MiscUtils.autoUnboxing(prodProductBranchService.findProdProductBranchList(parameters));
		...
		return "/prod/other/productbranch/findProductBranchList";
	}
	...
	public String showUpdateProductBranch(Model model, Long productBranchId, Long branchId) throws BusinessException {
		...
		return "/prod/other/productbranch/showUpdateBranch";
	}
	...
	public String showAddProductBranch(Model model, Long productId, Long branchId) throws BusinessException {
		...
		model.addAttribute("addValueTitle", ProdProductProp.PROP_ADD_VALUE_SPLIT);
		model.addAttribute("productId", productId);
		return "/prod/other/productbranch/showAddProductBranch";
	}
