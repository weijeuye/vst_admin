package com.lvmama.vst.back.prod.web.localTour;
 ...
 */
@Controller
@RequestMapping("/localTour/prod/product")
public class LocalTourProductAction extends BaseActionSupport {
	/**
	 * 
	 */
	private static final long serialVersionUID = 5967930951029299914L;

	private static final Log LOG = LogFactory.getLog(LocalTourProductAction.class);
...
//				}
		...
		return "/prod/localTour/product/findProdGroupList";
	}
	...
	public String showSelectReProductList(Model model,Long prodProductId, Long categoryId){
		model.addAttribute("prodProductId", prodProductId);
		model.addAttribute("categoryId", categoryId);
		return "/prod/localTour/product/showSelectReProductList";
	}
	...
	public String showProductMaintain(Model model, Long productId, String categoryName,Long categoryId,String isView) throws BusinessException {
		...
		return "/prod/localTour/product/showProductMaintain";
	}
