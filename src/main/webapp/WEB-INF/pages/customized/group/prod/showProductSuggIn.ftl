                        ...
                        <dl class="clearfix">
                            ...
                            <dd class="gi-checkbox-group js-checkbox-group">
                                ...
                                <label>
                                    ...
                                    <em>旅游者如系
                                        <input type="text" name="bookInforAge1" value="${travelAlertInnerVO.bookInforAge1!'70'}" class="gi-w50 js-input" <#if is_book_infor_item_001_selected == 'N'>disabled</#if> maxlength="4" data-validate="true" required digits="true"/>
                                        岁以上（含 
                                        <input type="text" name="bookInforAge2" value="${travelAlertInnerVO.bookInforAge2!'70'}" class="gi-w50 js-input" <#if is_book_infor_item_001_selected == 'N'>disabled</#if> maxlength="4" data-validate="true" required digits="true"/>
                                ...
                                <div class="clearfix">
                                <label>
                                    <input type="checkbox" name="bookInfor" value="002" <#if travelAlertInnerVO.bookInfor?? && travelAlertInnerVO.bookInfor?seq_contains("002")>checked="checked"</#if>/>
