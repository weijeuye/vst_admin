...
<div class="p_box">
<form method="post" action='/vst_admin/front/destAdvertising/findDestList.do' id="searchForm">
    <table class="s_table">
        <tbody>
            <tr>
...
$("a.editDestAdvertising").bind("click",function(){
	...
	var url = "/vst_admin/front/destAdvertising/destAdvertisingHeader.do?showTab=ALL&destId="+destId;
	showEditDestAdvertisingDialog = new xDialog(url,{},{title:"设置广告栏",width:1130,height:800});
