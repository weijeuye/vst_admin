...
<form method="post" action='/vst_admin/front/districtAround/selectDistrictList.do' id="searchForm">
...
var parentDistrictId = window.parent.districtID;
...
$("input[type='radio']").bind("click",function(){
	...
	var district = {};
	if(parentDistrictId == $("input[name='districtIdHide']",obj).val()){
	 alert("无效关联对象");
	 return;
	}
