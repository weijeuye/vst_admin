       ...
       <div class="p_box box_info p_line">
            ...
            <tbody>
                ...
                <tr>
                    ...
                    <td>
                    	<input type="text" class="w35" id="districtForVisa" name="district" required=true  readonly="readonly" value="<#if prodProduct.bizDistrict??>${prodProduct.bizDistrict.districtName!''}</#if>" required>
...
$(function(){
	$.ajax({
		url : "/vst_admin/biz/district/searchDistrictList.do",
		type : "post",
		dataType : 'json',
	...
	$("#save").bind("click",function(){
		  ...
		  if(refreshSensitiveWord($("input[type='text'],textarea"))){
    		...
    		$.confirm(msg,function(){
				...
				$.ajax({
					url : "/vst_admin/visa/product/updateProduct.do",
					type : "post",
					dataType : 'json',
