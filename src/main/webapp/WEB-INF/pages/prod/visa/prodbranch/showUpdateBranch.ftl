                        ...
                        <tbody>
			                ...
			                <tr>
			                    <td width="150" class="e_label td_top"><i class="cc1">*</i>签证名称：</td>
			                     <td><label><input type="text" name="branchName" id="branchName" value="${productBranch.branchName!''}" required=true maxlength="35" class="w35">"案例，大床房 "</label></td>
			                 </tr>
			                 <tr>
...
<script>
  ...
  $("#save").bind("click",function(){
		  ...
		  if(refreshSensitiveWord($("input[type='text'],textarea"))){
			...
			$.ajax({
			url : "/vst_admin/visa/prodbranch/updateProductBranch.do",
			type : "post",
			dataType:"json",
			async: false,
