...
var addDialog,updateDialog;
	...
	$("a.editProp").bind("click",function(){
		...
		updateDialog = new xDialog("/vst_admin/visa/prodbranch/showUpdateBranch.do",{"productBranchId":productBranchId , "branchId":branchId,"productId":productId}, {title:"修改产品规格",width:1000});
});
	...
	$("a.editFlag").bind("click",function(){
	 ...
	 $.confirm(msg, function () {
	  $.get("/vst_admin/visa/prodbranch/editFlag.do?productBranchId="+productBranchId+"&cancelFlag="+cancelFlag, function(result){
...
//新建
	...
	$("li a").bind("click",function(){
		...
		var productId = ${productId!''}; 
		addDialog = new xDialog("/vst_admin/visa/prodbranch/showAddProductBranch.do",{"branchId":branchId , "productId":productId}, {title:"新增产品规格",width:1000})
		});
</script>
