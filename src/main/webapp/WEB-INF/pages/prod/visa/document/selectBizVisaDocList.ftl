...
<form method="post" action='/vst_admin/visa/visaDoc/selectBizVisaDocList.do' id="searchForm">
<input type="hidden" name="dictDefId" value="${dictDefId!''}">
    <table class="s_table">
			<tr>
                ...
                <td class="w15">
                    <input type="text" name="docId" value="${bizVisaDoc.docId!''}" number="true"  maxLength="11">
                </td>
