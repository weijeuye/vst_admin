...
<div class="iframe_search">
	<form id="searchForm" action="/vst_admin/visa/visaDoc/findBizVisaDocList.do"  method="post">
		<table class="s_table">
			<tr>
						...
						<tr>
							...
							<td>
	                            ...
	                            <a href="javascript:void(0);" class="showLogDialog"
								   param='objectId=${bizVisaDoc.docId}&objectType=VISA_DOCUMNET&sysName=VST'>操作日志</a>
							</td>
						</tr>						
					</#list>
                </tbody>
...
vst_pet_util.visaCountrySuggest("#country","#country");
	$(function(){
		...
		$("#new_button").bind("click",function(){
			addBizVisaDoc = new xDialog("/vst_admin/visa/visaDoc/showBizVisaDoc.do",{}, {title:"新增签证材料",width:600});	 
		});	
		
		//跳转到签证材料信息页面
		$(".update").bind("click",function(){
		    var docId =$(this).attr("data");
			updateBizVisaDoc = new xDialog("/vst_admin/visa/visaDoc/showBizVisaDoc.do",{docId:docId}, {title:"修改签证材料",width:600});	 
		});	
...
//设置为有效或无效
	$("a.cancelProd").bind("click",function(){
	 ...
	 $.confirm(msg, function () {
		$.ajax({
			url : "/vst_admin/visa/visaDoc/cancelBizVisaDoc.do",
			type : "post",
			dataType:"JSON",
	...
	$(".edit").bind("click",function(){
		...
		location.href="/vst_admin/visa/visaDoc/showBizVisaDocOccup.do?docId="+docId;
