<form action="/vst_admin/visa/visaDoc/showBizVisaDoc.do" method="post" id="dataForm">
            ...
            <tbody>
                ...
                <tr>
                	...
                	<td colspan=2>
                		...
                		<input type="hidden" name="districtId" id="districtId" <#if bizVisaDoc?? && bizVisaDoc.districtId??>value="${bizVisaDoc.districtId}"</#if>/>
                	</td>
                </tr>
                <tr>
...
<script>
vst_pet_util.visaCountrySuggest("#country1", "input[name=districtId]");
		...
		$("#saveVisaDoc").bind('click',function(){
			...
			$("input[name=senisitiveFlag]").val("N");
		 	...
		 	$.confirm(msg,function(){
		 		$.ajax({
				url : "/vst_admin/visa/visaDoc/updateBizVisaDoc.do",
				type : "post",
