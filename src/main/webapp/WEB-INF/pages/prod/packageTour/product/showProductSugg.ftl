...
<form action="/vst_admin/prod/product/addProduct.do" method="post" id="dataForm">
       ...
       <div class="p_box box_info">
        	...
        	<!-- 条款品类属性分组Id -->
       		<#assign suggGroupIds = [26,27,28,29,30,31,32,33,86]/>  
		             		...
		             		<tbody>
			                	<#list bizCatePropGroup.bizCategoryPropList as bizCategoryProp>
			                		<#if (bizCategoryProp??)>
				                		...
				                		<#if propId!='608' && prodProduct.subCategoryId == '181' && prodProduct.bu == 'DESTINATION_BU'> 
					                		<tr>
				                		...
				                		<#if prodProduct.subCategoryId != '181' || prodProduct.bu != 'DESTINATION_BU'> 
				                			<tr>
								                <td width="150" class="e_label td_top" style="text-align:left" >
								                	<#if bizCategoryProp.nullFlag == 'Y'><span class="notnull">*</span></#if>
								                		<span>${bizCategoryProp.propName!''}</span>
...
$(function(){
	...
	$("#save").bind("click",function(){
			...
			$.confirm(msg,function(){
				...
				$.ajax({
					url : "/vst_admin/packageTour/prod/product/updateProductSugg.do",
					type : "post",
					dataType : 'json',
