	                ...
	                <table class="e_table form-inline ">
	                   <tbody>
						...
						<#list branchPropList as branchProp>
			                <tr>
				                <td width="100" class="e_label td_top"><i class="cc1">*</i>${branchProp.propName!''}<#if branchProp.nullFlag == 'Y'><i class="cc1">*</i></#if>：</td>
			                	<td>
			                		<#if productBranch.productBranchId == null>
	                    	...
	                    	<tr>
	                   		...
	                   		<tr>
			                    ...
			                    <td>
				                    ...
				                    <input type="radio"  name="relationType" value="AMOUNT" <#if prodBranchRelationType??&&prodBranchRelationType.relationType=='AMOUNT'>checked=checked</#if>>等量
			                    </td>
			                </tr>
	        			</tbody>
	                </table>
...
$(document).ready(function(){
	...
	$("#addHotel").click(function(){
	     ...
	     addChangeHotelDialog = new xDialog("/vst_admin/biz/changeHotel/showAddChangeHotel.do",{"productId":productId,"branchId":"${productBranch.branchId!''}"},{title:"新增可换酒店",width:1000,height:800,zIndex:200});
		 return;
	});
	...
	$("#updateHotel").click(function(){
	     ...
	     if(null != dictId && ""!=dictId){
	       		updateChangeHotelDialog = new xDialog("/vst_admin/biz/changeHotel/showUpdateChangeHotel.do",{"dictId":dictId,"branchId":"${productBranch.branchId!''}"},{title:"编辑可换酒店",width:1000,height:900,zIndex:200});
		        return;
	     }
	});
});
...
//	$("#cancelFlag").removeAttr("disabled");
	...
	var msg = '确认保存吗 ？';	
	 ...
	 $.confirm(msg,function(){
		...
		//提交新增
		$.ajax({
			url : "/vst_admin/packageTour/prod/prodbranch/saveProductBranch.do",
			type : "post",
			dataType:"json",
			async: false,
