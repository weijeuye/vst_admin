        ...
        <div class="box_content JS_line_prd">
            <table class="e_table form-inline">
                ...
                <form action="/vst_admin/prod/traffic/updateProdTraffic.do" method="post" id="dataForm">
                    ...
                    <input type="hidden" id="productId" name="categoryId" value="${categoryId!''}">
                    <input type="hidden" id="trafficId" name="trafficId"
                           value="<#if prodTraffic??>${prodTraffic.trafficId!''}</#if>">
                    <input type="hidden" id="toTypeCode" name="toTypeCode"
                           value="<#if prodTraffic??>${prodTraffic.toType!''}</#if>"/>
                    <input type="hidden" id="toBackCode" name="toBackCode"
                           value="<#if prodTraffic??>${prodTraffic.backType!''}</#if>"/>
                    ...
                    <tr>
                        ...
                        <td>
                            ...
                            <#if categoryId?? && categoryId==16>
                                <option value="BUS"
                                        <#if prodTraffic?? && prodTraffic.toType=="BUS">selected=selected</#if>>汽车
                                </option>
                            <#else>
                    ...
                    <tr>
                        ...
                        <td>
                            ...
                            <#if categoryId?? && categoryId==16>
                                <option value="BUS"
                                        <#if prodTraffic?? && prodTraffic.backType=="BUS">selected=selected</#if>>汽车
                                </option>
                            <#else>
                                <#list trafficTypeList as list>
                    ...
                    <tr
                    <#if prodTraffic==null || (prodTraffic?? && prodTraffic.toType!='BUS') >style="display:none"</#if>
                    id="cheseFlag2">
                        <td class="e_label"><i class="cc1">*</i>巴士去程上车点是否下单可选：</td>
                        <td>
                            <input type="radio" name="cheseFlag2" value="Y" checked=checeked
                                   <#if prodTraffic?? && prodTraffic.cheseFlag2=='Y'>checked=checeked</#if>>是
                            <input type="radio" name="cheseFlag2" value="N"
                                   <#if prodTraffic?? && prodTraffic.cheseFlag2=='N'>checked=checeked</#if>>否
                    ...
                    <tr>
                        ...
                        <td>
                            <label>
                                <input class="lp-radio" type="radio" name="referFlag" value="Y" checked=checeked
                                       <#if prodTraffic?? && prodTraffic.referFlag == 'Y'>checked=checeked</#if>>是
                            </label>
                            <label>
                                <input class="lp-radio" type="radio" name="referFlag" value="N"
                                       <#if prodTraffic?? && prodTraffic.referFlag == 'N'>checked=checeked</#if>>否
                            </label>
                ...
                <tr>
                    ...
                    <#else>
                        <div class="fl operate">
                            <a class="btn btn_cc1" href="/vst_admin/biz/flight/findFlightList.do"
                               target="_blank">维护航班</a>
