...
<td>
<select class="form-control" id="priority${tag}" style="width:110px;height:30px;" name="" >
...
<td>
<select class="form-control" id="tripFlag${tag}" style="width:110px;height:30px;" name="">
...
<script>
	...
	$("#saveAirLine").bind("click",function(){
		...
		arr=arr;
		$.ajax({
			url : "/vst_admin/airlineQuery/saveSetting.do",
			type : "post",
			async: false,
			traditional: true,
			data:{arr:arr,productId:productId},
