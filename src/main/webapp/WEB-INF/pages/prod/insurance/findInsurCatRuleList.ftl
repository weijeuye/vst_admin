        ...
        <tbody>
			<#list bizInsurCatRuleList as bizInsurCatRule> 
				<tr>
					...
					<#if bizInsurCatRule.daysFlag =="Y">被保天数&nbsp;</#if>
					<#if bizInsurCatRule.lineFlag =="Y">所属航线</#if></td>
					<td class="oper">
						<a class="editBizInsurCatRule" href="javascript:;" data="${bizInsurCatRule.ruleId!''}" data2="${bizInsurCatRule.categoryId!''}">编辑</a>
                    </td>
				</tr>
			</#list>
        </tbody>
...
$(function(){
	...
	$("a.editBizInsurCatRule, #new_button").bind("click",function(){
	    ...
	    if(categoryId != null) {
	    	var url = "/vst_admin/insurance/InsurCatRule/showAddUpdateInsurCatRule.do?categoryId="+categoryId;
	    } else {
	    	var url = "/vst_admin/insurance/InsurCatRule/showAddUpdateInsurCatRule.do";
	    }
	...
	$("a.editFlag").bind("click",function(){
		 ...
		 var url = "/vst_admin/biz/dict/editDictFlag.do?dictId="+dictId+"&cancelFlag="+dictCancelFlag+"&newDate="+new Date();
