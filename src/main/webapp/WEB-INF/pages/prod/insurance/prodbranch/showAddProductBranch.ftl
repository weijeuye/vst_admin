                    ...
                    <table class="e_table form-inline ">
                        <tbody>
			                ...
			                <tr>
			                    ...
			                    <td><label><input type="text" name="branchName" id="branchName" required=true maxLength=35 class="w35">"案例，经济型 "</label>
...
$("#save").bind("click",function(){
	...
	$.confirm(msg,function(){
		...
		$.ajax({
			url : "/vst_admin/insurance/prod/prodbranch/addProductBranch.do",
			type : "post",
			dataType:"json",
			async: false,
