                    ...
                    <tbody>
		                ...
		                <tr>
		                    <td width="150" class="e_label td_top"><i class="cc1">*</i>名称：</td>
		                     <td><label><input type="text" name="branchName" id="branchName" value="${productBranch.branchName!''}" maxLength=35 required=true class="w35">"案例，经济型 "</label></td>
		                 </tr>
		                 <tr>
...
$("#save").bind("click",function(){
	...
	$.confirm(msg, function () {
		...
		$.ajax({
			url : "/vst_admin/insurance/prod/prodbranch/updateProductBranch.do",
			type : "post",
			dataType:"json",
			async: false,
