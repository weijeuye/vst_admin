            ...
            <tbody>
                <tr>
                    ...
                    <td class="w18">
	                    ...
	                    <input type="hidden" name="stayNum" id="stayNum"/>
                    </td>
...
<div class="p_box" id="dataDiv">
	<#include "prod/selfTour/product/selectReProductList.ftl"/>
</div>
   </form>
  <div class="operate">
  ...
  <script>
	...
	isView();
 	...
 	$("#search_button").click(function(){
		$.ajax({
			url : '/vst_admin/selfTour/prodGroup/selectReProductList.do',
			type : 'POST',
	...
	function saveProdGroup(obj){
		$.ajax({
			url : '/vst_admin/selfTour/prodGroup/saveProdGroup.do',
			type : 'POST',
			//async : false,
