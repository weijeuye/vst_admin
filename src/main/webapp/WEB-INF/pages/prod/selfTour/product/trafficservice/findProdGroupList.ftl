...
<script>
	...
	$("#select").click(function(){
		...
		productSelectDialog = new xDialog("/vst_admin/selfTour/prod/product/trafficservice/showSelectReProductList.do",{prodProductId:'${prodProductId}',categoryId:'${categoryId}'},{title:"选择关联产品",width:"1150",height:"350"});
	});
