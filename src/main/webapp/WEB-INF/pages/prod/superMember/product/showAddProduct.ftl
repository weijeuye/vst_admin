        ...
        <table class="e_table form-inline">
          ...
          <tr>
            ...
            <td><label><input type="text" class="w35" style="width:700px" name="productName" id="productName"
                              required="true" maxlength="50">&nbsp;<span
...
<#assign bizCategoryProp=bizCatePropGroup[0].bizCategoryPropList />
          <tr>
          	...
          	<td>
            	<textarea class="w35 textWidth" style="width:700px; height:100px; resize: none;" required=""
                      name="prodProductPropList[0].propValue" maxlength="500"></textarea>
...
<script>
    ...
    $("#save").click(function () {
        ...
        $.confirm(msg,function(){
            ...
            $.ajax({
                url: "/vst_admin/supermember/prod/product/addProduct.do",
                type: "post",
                dataType: 'json',
