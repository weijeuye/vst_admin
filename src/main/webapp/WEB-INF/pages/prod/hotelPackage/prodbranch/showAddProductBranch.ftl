                ...
                <div class="box_content ">
                    <table class="e_table form-inline ">
                        <tbody>
			                ...
			                <tr>
			                 	<td width="150" class="e_label td_top"><i class="cc1">*</i>产品名称：</td>
			                    <td><label><input type="text" name="branchName" id="branchName" required=true maxlength="50" class="w35"></label></td>
			                </tr>    
			               <tr>
