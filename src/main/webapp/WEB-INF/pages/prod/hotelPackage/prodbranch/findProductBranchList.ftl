...
<!-- 主要内容显示区域\\ -->
				<div>
	                	<form method="post" action='/vst_admin/ship/prod/prodbranch/findProductBranchList.do' id="searchForm">
	                	<input type="hidden" name="productId" value="${productId}"/>
	                	<input type="hidden" name="categoryId" value="${categoryId}"/>
	                	规格状态:<select name="cancelFlag" id="cancelFlag">
            			...
            			<table class="p_table table_center">
				                ...
				                <tbody>
									...
									<td class="oper">
				                            ...
				                            <a href="javascript:void(0);" class="showLogDialog" param='objectId=${productBranch.productBranchId!''}&objectType=PROD_PRODUCT_BRANCH&sysName=VST'>操作日志</a>
...
var addDialog,updateDialog;
	...
	$("a.showPhoto").bind("click",function(){
		var url="/vst_admin/pub/comphoto/findComPhotoList.do?objectId="+$(this).attr("data")+"&parentId="+$(this).attr("parentId")+"&objectType=PRODUCT_BRANCH_ID&logType="+$(this).attr("logType");
	...
	$("a.editProp").bind("click",function(){
		...
		updateDialog = new xDialog("/vst_admin/ship/prod/prodbranch/showUpdateBranch.do",{"productBranchId":productBranchId , "branchId":branchId}, {title:"修改产品规格",width:900});
});
	...
	$("a.editFlag").bind("click",function(){
	 ...
	 $.confirm(msg, function () {
	  $.get("/vst_admin/ship/prod/prodbranch/editFlag.do?productBranchId="+productBranchId+"&cancelFlag="+cancelFlag, function(result){
...
//新建
	...
	$("li a").bind("click",function(){
		...
		addDialog = new xDialog("/vst_admin/ship/prod/prodbranch/showAddProductBranch.do",{"branchId":branchId , "productId":productId}, {title:"新增产品规格",width:900})
		});
</script>
