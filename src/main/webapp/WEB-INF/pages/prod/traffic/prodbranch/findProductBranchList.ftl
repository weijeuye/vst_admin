	                ...
	                <#list prodProductBranchMap?keys as testKey>
            			...
            			<table class="p_table table_center">
				                ...
				                <tbody>
									...
									<#if bizCategory.categoryId==25>  
				                	 <td>${productBranch.departureStation!''}</td>
				                	 <td>${productBranch.arrivalStation!''}</td>
				                	</#if>
...
var addDialog,updateDialog;
	...
	$("a.editProp").bind("click",function(){
		...
		updateDialog = new xDialog("/vst_admin/prod/traffic/prodbranch/showUpdateBranch.do",{"productBranchId":productBranchId , "branchId":branchId}, {title:"修改产品规格",width:900});
});
	...
	$("a.editFlag").bind("click",function(){
	 ...
	 $.confirm(msg, function () {
	  $.get("/vst_admin/prod/traffic/prodbranch/editFlag.do?productBranchId="+productBranchId+"&cancelFlag="+cancelFlag, function(result){
...
//新建
	...
	$("li a").bind("click",function(){
		...
		addDialog = new xDialog("/vst_admin/prod/traffic/prodbranch/showAddProductBranch.do",{"branchId":branchId , "productId":productId}, {title:"新增产品规格",width:900})
		});
</script>
