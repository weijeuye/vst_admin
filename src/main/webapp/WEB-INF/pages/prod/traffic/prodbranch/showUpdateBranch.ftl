...
<input type="hidden" name="cancelFlag" value="${productBranch.cancelFlag!''}">
            ...
            <div class="p_box box_info p_line">
                <div class="box_content ">
                    <table class="e_table form-inline ">
                        <tbody>
                            <tr>
			                	 <td width="150" class="e_label td_top">所属规格：</td>
			                ...
			                <tr>
			                    <td width="150" class="e_label td_top"><i class="cc1">*</i>产品规格名称：</td>
			                     <td><label><input type="text" name="branchName" id="branchName" value="${productBranch.branchName!''}" required=true maxlength="35" class="w35"></label></td>
			                 </tr>
			               <#if productBranch?? &&productBranch.bizBranch&&productBranch.bizBranch.categoryId==25> 
			                <tr>
			                 	<td width="150" class="e_label td_top"><i class="cc1">*</i>出发车站：</td>
			                    <td><label><input type="text" name="departureStation" id="departureStation" value="${productBranch.departureStation!''}" required=true maxlength="48" class="w35"></label></td>
			                </tr> 
			                <tr>
			                 	<td width="150" class="e_label td_top"><i class="cc1">*</i>到达车站：</td>
			                    <td><label><input type="text" name="arrivalStation" id="arrivalStation"  value="${productBranch.arrivalStation!''}" required=true maxlength="48" class="w35"></label></td>
			                </tr>
			                </#if>   
			                 
			                 <tr>
				                 <td width="150" class="e_label td_top"><i class="cc1">*</i>是否有效：</td>
				                    <td><#if productBranch.cancelFlag == 'Y'>有效<#else>无效</#if>
...
<script>
  ...
  $("#save").bind("click",function(){
			...
			$.ajax({
			url : "/vst_admin/prod/prodbranch/updateProductBranch.do",
			type : "post",
			dataType:"json",
			async: false,
