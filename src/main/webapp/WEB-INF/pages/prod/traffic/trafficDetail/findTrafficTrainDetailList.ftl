...
isView();
  $("#new_button").click(function(){
			showAddTrafficTrainDetailDialog = new xDialog("/vst_admin/prod/traffic/showAddTrafficTrainDetail.do",{productId:$("#prodProductId").val()},{title:"新增车次",width:400});	
	});
	
	$(".editProp").click(function(){
		var trainId = $(this).attr("trainId");
		showUpdateTrafficTrainDetailDialog = new xDialog("/vst_admin/prod/traffic/showUpdateTrafficTrainDetail.do",{productId:$("#prodProductId").val(),"trainId":trainId},{title:"修改车次",width:400});	
	});
