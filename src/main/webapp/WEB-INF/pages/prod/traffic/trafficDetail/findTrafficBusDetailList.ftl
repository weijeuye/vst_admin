...
var showUpdateTrafficTrainDetailDialog;
  $("#new_button").click(function(){
			showAddTrafficTrainDetailDialog = new xDialog("/vst_admin/prod/traffic/showAddTrafficBusDetail.do",{productId:$("#prodProductId").val()},{title:"新增车次",width:500});	
	});
	
	$(".editProp").click(function(){
		var busId = $(this).attr("busId");
		showUpdateTrafficTrainDetailDialog = new xDialog("/vst_admin/prod/traffic/showUpdateTrafficBusDetail.do",{productId:$("#prodProductId").val(),"busId":busId},{title:"修改车次",width:500});	
	});
	...
	$(".delete").click(function(){
		...
		$.confirm('确认删除?',function(){
				$.ajax({
					url : "/vst_admin/prod/traffic/deleteTrafficBusDetail.do",
					type : "post",
					dataType:"JSON",
					data : {"busId":busId},
