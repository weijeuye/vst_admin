<form action="/vst_admin/prod/traffic/showAddTrafficTrainDetail.do" method="post" id="dataForm" class="dataForm">
...
<script> 
	vst_pet_util.commListSuggest($("#toType"),$("form"),'/vst_admin/prod/traffic/searchTrainNoList.do','');
	isView();
	$("#save").click(function(){
				if($("#toType").val()==""){
						$.alert("请输入车次信息");
				...
				$.ajax({
					url : "/vst_admin/prod/traffic/updateTrafficTrainDetail.do",
					type : "post",
