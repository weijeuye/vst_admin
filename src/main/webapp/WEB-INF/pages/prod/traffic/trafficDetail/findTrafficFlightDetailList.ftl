...
var showUpdateTrafficFlightDetailDialog;
  $("#new_button").click(function(){
			showAddTrafficFlightDetailDialog = new xDialog("/vst_admin/prod/traffic/showAddTrafficFlightDetail.do",{productId:$("#prodProductId").val()},{title:"新增航班",width:400});	
	});
	
	$(".editProp").click(function(){
		var groupId = $(this).attr("groupId");
		showUpdateTrafficFlightDetailDialog = new xDialog("/vst_admin/prod/traffic/showUpdateTrafficFlightDetail.do",{productId:$("#prodProductId").val(),"groupId":groupId},{title:"修改航班",width:400});	
	});
	...
	//设置为有效或无效
		$("a.cancelProp").bind("click",function(){
			...
			$.ajax({
				url : "/vst_admin/prod/traffic/updateFlightCancelFlag.do",
				type : "post",
				dataType:"JSON",
