		...
		<div class="p_box box_info p_line">
                ...
                <table class="e_table form-inline">
					...
					<tr>
	               	...
	               	<tr>
						...
						<td>
						<input type="text" style="width:50px"  id="propPerson0" name="propPerson" number="true" placeholder="" autovalue="true">  - 
						<input type="text" style="width:50px" id="propPerson1"  name="propPerson" number="true" placeholder="" autovalue="true">
	                ...
	                <tr>
						...
						<td>
							<textarea  name="feature"  rows="3"  maxlength="1500"  style="width:500px" required=true></textarea>
	                    </td>
	                </tr>
	                <tr>
	                	<td class="e_label"><i class="cc1">*</i>参考价格</td>
	                 	 <td>
	                    	<input type="radio"  name="price1"  value="YTYY" required/>一团一议
	                    	<input type="radio"  name="price1"  value="SJ" required/>实价
	                    	<input type="text" style="width:50px" name="price"  id="priceNum" number="true" placeholder="" required=true autovalue="true">
	                 ...
	                 <tr>
						...
						<td>
							<textarea  name="managerRec"  rows="3"  maxlength="1500"  style="width:500px"></textarea>
	                    </td>
	                </tr>
                	</tbody>
                </table>
           ...
           <div class="p_box box_info p_line">
			  ...
			  <div class="box_content">
                <table class="e_table form-inline">
                    <tbody>
		        	<#if customizedProduct.prodDestReList?? && (customizedProduct.prodDestReList?size &gt; 0)>
		                <#list customizedProduct.prodDestReList as prodDestRe>
			                <tr <#if prodDestRe_index=0>name='no1'</#if>>
			                	<#if prodDestRe_index=0>
						   			<td name="addspan" rowspan='${cutomizedProduct.customizedProdDestReList?size}' class="e_label">目的地：</td>
						   		</#if>
					            <td>
					            	...
					            	<input type="hidden" name="customizedProdDestReList[${prodDestRe_index}].productId" value="${prodProduct.productId}">
...
var busiSelectIndex;//酒店业务字典
	...
	$("#save").click(function(){
		...
		if(dest == '') {
			$("#addDestTip").html("目的地不能为空").css({'color':'red'});
			return false;
		} else {
			$("#addDestTip").html("");
		}
		 ...
		 $.confirm(msg,function(){
			...
			$.ajax({
				url : "/vst_admin/prod/customized/addProduct.do",
				type : "post",
				dataType : 'json',
