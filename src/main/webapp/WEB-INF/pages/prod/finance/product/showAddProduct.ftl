...
<div class="iframe_content mt10">
  ...
  <form action="/vst_admin/finance/product/addProduct.do" method="post" id="dataForm">
        ...
        <table class="e_table form-inline">
          ...
          <tr>
            ...
            <td><label><input type="text" class="w35" style="width:700px" name="productName" id="productName"
                              required="true" maxlength="70">&nbsp;<span
          ...
          <tr>
            ...
            <td>
              <input type="text" class="w35 searchInput" name="managerName" id="managerName" required="" value=""
                     autocomplete="off">
...
<#assign bizCategoryProp=bizCatePropGroup[0].bizCategoryPropList />
          <tr>
            ...
            <td>
              	<input type="text" name="prodProductPropList[0].propValue" errorele="selectDate" class="Wdate" id="d4321"
              ...
              <span>-</span>
              	<input type="text" name="prodProductPropList[1].propValue" errorele="selectDate" class="Wdate" id="d4322"
          ...
          <tr>
            ...
            <td>
              <input type="text" name="prodProductPropList[2].propValue" errorele="selectDate" class="Wdate" id="d4323"
              ...
              <span>-</span>
              <input type="text" name="prodProductPropList[3].propValue" errorele="selectDate" class="Wdate" id="d4324"
    ...
    <div class="p_box box_info p_line">
      <table class="e_table form-inline">
        ...
        <tr>
          ...
          <td>
            <textarea class="w35 textWidth" style="width:700px; height:50px; resize: none;" required=""
                      name="prodProductPropList[4].propValue" maxlength="400"></textarea>
        ...
        <tr>
          ...
          <td>
            <textarea class="w35 textWidth" name="prodProductPropList[5].propValue"
            	 	style="width:700px; height:50px;resize: none;" maxlength="400"></textarea>
        ...
        <tr>
          ...
          <td>
            <textarea class="w35 textWidth" name="prodProductPropList[6].propValue" 
            		style="width:700px; height:50px;resize: none;" maxlength="2000"></textarea>
        ...
        <tr>
          ...
          <td>
            ...
            <div class="js_rgtgInput" style="display: inline-block;">
              <textarea class="w35 textWidth" name="ruleContent" required="" style="width:700px; height:50px;resize: none;"></textarea>
...
<script>
    ...
    $("#save").click(function () {
        ...
        $.confirm(msg,function(){
            ...
            $.ajax({
                url: "/vst_admin/finance/prod/product/addProduct.do",
                type: "post",
                dataType: 'json',
