        ...
        <table class="p_table form-inline">
           ...
           <#else>
                 ...
                 <tr>   
                    ...
                    <td><textarea class="w35 textWidth" style="height:250px;width:550px" name="content" maxlength=1000 required></textarea></td>  
				 </tr>     
...
var disflag = false;
		...
		$("#save").bind("click",function(){
			...
			$.ajax({
			url : "/vst_admin/prod/productNotice/addProductNotice.do",
			type : "post",
			dataType:"json",
			async: false,
