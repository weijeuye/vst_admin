...
<form  id="dataForm">
				<tbody>
                    <tr>
                    	...
                    	<input id="productId" name="productId" type="hidden" value ="${productNotice.productId!''}">
            ...
            <tbody>
              ...
              <#else>
                 ...
                 <tr>
                    ...
                    <td><textarea class="w35 textWidth" style="height:250px;width:550px" name="content" required maxlength=1000 value="${productNotice.content!''}">${productNotice.content!''}</textarea></td>  
				 </tr>  
...
{   	
	         $.ajax({
					url : "/vst_admin/goods/goods/findSuppGoodsJson.do",
					type : "post",
					async: false,
		...
		$("#save").bind("click",function(){
			...
			$.ajax({
			url : "/vst_admin/prod/productNotice/updateProductNotice.do",
			type : "post",
			dataType:"json",
			async: false,
