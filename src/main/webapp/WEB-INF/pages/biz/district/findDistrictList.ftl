...
<div class="p_box">
<form method="post" action='/vst_admin/biz/district/findDistrictList.do' id="searchForm">
    <table class="s_table">
        <tbody>
            <tr>
        ...
        <tbody>
			...
			<tr>
				...
				<td class="oper">
	                ...
	                <a href="/vst_admin/pub/comCoordinate/modifyCoordinate.do?objectId=${bizDistrict.districtId!''}&objectType=BIZ_DISTRICT&coordType=BAIDU&searchKey=${bizDistrict.districtName!''} <#if bizDistrict.parentDistrict ??>${bizDistrict.parentDistrict.districtName!''}</#if>">设置百度经纬度</a>
                    <a href="/vst_admin/pub/comCoordinate/modifyCoordinate.do?objectId=${bizDistrict.districtId!''}&objectType=BIZ_DISTRICT&coordType=GOOGLE&searchKey=${bizDistrict.districtName!''} <#if bizDistrict.parentDistrict ??>${bizDistrict.parentDistrict.districtName!''}</#if>">设置谷歌经纬度</a>
	              </td>
				</tr>
			</#list>
        </tbody>
...
$("#new_button").bind("click",function(){
	var url = "/vst_admin/biz/district/showAddDistrict.do";
...
$("a.editProp").bind("click",function(){
	...
	var url = "/vst_admin/biz/district/showUpdateDistrict.do";
...
$("a.cancelProp").bind("click",function(){
	...
	$.ajax({
		url : "/vst_admin/biz/district/cancelDistrict.do",
		type : "post",
...
$("a.addChild").bind("click",function(){
	var districtId = $(this).attr("data");
	var url = "/vst_admin/biz/district/showAddChildDistrict.do?districtId="+districtId;
	dialog(url, "新增下级行政区", 800, "auto",function(){
		if(!$("#dataForm").validate().form()){
			return false;
		}
		$.ajax({
			url : "/vst_admin/biz/district/addDistrict.do",
			type : "post",
