            ...
            <tbody>
            	...
            	<tr>
	            	...
	            	<#list destMarkList as destMark>
	            	    <#if destMark.code??>
	            		  <option value="${destMark.code!''}">${destMark.cnName!''}</option>
	            		</#if>
	            	</#list>		
	            	</select>
                    </td>
...
$("#parentName").click(function(){
	destSelectDialog = new xDialog("/vst_admin/biz/dest/selectDestList.do?type=main&parentDestId="+$("#parentId").val(),{},{title:"选择目的地",iframe:true,width:"1000",height:"600"});
});
...
$("#editButton").bind("click",function(){
	...
	$.ajax({
	url : "/vst_admin/biz/dest/addDest.do",
	type : "post",
	dataType:"json",
	async: false,
...
$("a.otherParentDests").click(function() {
   if($("#parentName").val()==""){
	...
	otherDestSelectDialog = new xDialog("/vst_admin/biz/dest/selectDestList.do?type=other&parentDestId="+$("#parentId").val(),{},{title:"选择(次)父级目的地",iframe:true,width:"1000",height:"700"});
});  
