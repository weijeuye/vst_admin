        ...
        <tbody>
			...
			<tr>
				...
				<td class="oper">
                    ...
                    <a href="/vst_admin/pub/comCoordinate/modifyCoordinate.do?objectId=${bizDistrictSign.signId!''}&objectType=BIZ_DISTRICT_SIGN&coordType=BAIDU&searchKey=${bizDistrictSign.signName!''} ${bizDistrictSign.districtName!''}&signTypeName=${bizDistrictSign.signTypeBizDict.dictName}">设置百度经纬度</a>
                    <a href="/vst_admin/pub/comCoordinate/modifyCoordinate.do?objectId=${bizDistrictSign.signId!''}&objectType=BIZ_DISTRICT_SIGN&coordType=GOOGLE&searchKey=${bizDistrictSign.signName!''} ${bizDistrictSign.districtName!''}&signTypeName=${bizDistrictSign.signTypeBizDict.dictName}">设置谷歌经纬度</a>
                    <#if bizDistrictSign.cancelFlag == "Y"> 
...
$("#new_button").bind("click",function(){
	var url = "/vst_admin/biz/districtSign/showAddDistrictSign.do";
...
$("a.editProp").bind("click",function(){
	...
	var url = "/vst_admin/biz/districtSign/showUpdateDistrictSign.do";
...
$("a.cancelProp").bind("click",function(){
	...
	$.ajax({
		url : "/vst_admin/biz/districtSign/cancelDistrictSign.do",
		type : "post",
