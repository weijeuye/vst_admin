...
<div class="iframe_search">
	<form method="post" action='/vst_admin/biz/attribution/selectAttributionList.do?multi=true' id="searchForm">
	    <table class="s_table">
	        <tbody>
		        <tr>
                    ...
                    <td class=" operate mt10"><a class="btn btn_cc1" id="save_button">确定</a></td>
	...
	<table class="p_table table_center">
	    ...
	    <tbody>
			<#list pageParam.items as attribution> 
				<tr>
					<td>
						<input type="checkbox" name="attributionId" value="${attribution.attributionId!''}">
