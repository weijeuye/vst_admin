...
<form method="post" action='/vst_admin/biz/seoLink/findSeoLinkList.do' id="searchForm">
    <table class="s_table">
        <tbody>
            <tr>
...
$("#import_button").bind("click",function(){
	var url = "/vst_admin/biz/seoLink/toShowUploadExecl.do?seoType=${seoType}";
	importDialog = new xDialog(url, {}, {title:"导入友链记录",width:800});
});

//新建单条
$("#new_button").bind("click",function(){
	var url = "/vst_admin/biz/seoLink/toSeoLinkAdd.do?seoType=${seoType}";
...
$("a.editSeoLink").bind("click",function(){
	...
	var url = "/vst_admin/biz/seoLink/toSeoLinkUpdate.do?seoType=${seoType}";
...
$("a.delSeoLink").bind("click",function(){
	 ...
	 $.confirm(msg, function () {
		 var url = "/vst_admin/biz/seoLink/doDeleteSeoLink.do?seoType=${seoType}&bizSeoFriendLinkIdList="+bizSeoFriendLinkId;
		 $.ajax({
			url : url,
			type : "post",
			dataType:'JSON',
...
$("#export_button").bind("click",function(){
	...
	var url = "/vst_admin/biz/seoLink/exportExcelData.do";
...
$("#del_select_button").bind("click",function(){
	...
	var url = "/vst_admin/biz/seoLink/doDeleteSeoLink.do?seoType=${seoType}&bizSeoFriendLinkIdList="+batchSeoLinks;
	var valid = "Y";
