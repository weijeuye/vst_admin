...
<div class="p_box">
<form method="post" action='/vst_admin/biz/trafficLine/findTrafficLineList.do' id="searchForm">
    <table class="s_table">
        <tbody>
            <tr>
...
$("#new_button").bind("click",function(){
	var url = "/vst_admin/biz/trafficLine/showAddTrafficLine.do";
...
$("a.editProp").bind("click",function(){
	...
	var url = "/vst_admin/biz/trafficLine/showUpdateTrafficLine.do";
...
$("a.cancelProp").bind("click",function(){
	...
	$.ajax({
		url : "/vst_admin/biz/trafficLine/modiTrafficLineFlag.do",
		type : "post",
