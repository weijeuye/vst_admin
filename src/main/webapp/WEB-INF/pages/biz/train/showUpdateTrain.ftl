...
<script>
    ...
    //自动补全车站信息
    vst_pet_util.commListSuggest($("#startStationString"),$("#startStation"),'/vst_admin/prod/traffic/searchTrainStationList.do','');
    vst_pet_util.commListSuggest($("#arriveStationString"),$("#arriveStation"),'/vst_admin/prod/traffic/searchTrainStationList.do','');
    ...
    $("#saveButton").on("click", function() {
        ...
        $.ajax({
            url : "/vst_admin/biz/train/updateTrain.do",
            type : "post",
            dataType : "json",
            async : false,
