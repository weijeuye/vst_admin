...
<html>
  ...
  <div class="iframe_content">   
    <div class="p_box">
        <form method="post" action='/vst_admin/biz/train/findTrainList.do' id="searchForm">
            <table class="s_table">
                <tbody>
                    <tr>
    ...
    <script>
        ...
        $("#new_button").on('click',function(){
            var url = "/vst_admin/biz/train/showAddTrain.do";
            addDialog = new xDialog(url, {}, {title:"新增车次信息",width:1000,height:800});
        });
        
        //修改
        $("a.editProp").on('click',function(){
            var trainId = $(this).attr("data");
            var url = "/vst_admin/biz/train/showUpdateTrain.do";
            updateDialog = new xDialog(url,{"trainId":trainId}, {title:"编辑车次信息",width:1000,height:800});
        });
        ...
        $("a.stopInfo").on('click',function(){
            ...
            var url = "/vst_admin/biz/trainStop/findTrainStopList.do";
        ...
        $("a.cancelProp").on("click",function(){
            ...
            if(confirm(msg)){    
                $.ajax({
                    url : "/vst_admin/biz/train/setTrainCancelFlag.do",
                    type : "post",
