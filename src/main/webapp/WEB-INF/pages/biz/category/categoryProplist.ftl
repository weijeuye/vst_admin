...
$("select[name='groupId']").change(function(){
   ...
   $("#page").val("1");
   var url = "/vst_admin/biz/categoryProp/findCategoryPropList.do?categoryId="+categoryId+"&groupId="+groupId;
...
$("#addCatePropButton").bind("click",function(){
    ...
    var url = "/vst_admin/biz/category/selectBizPropPoolList.do"+ param;
	//打开选择属性池列表
...
$("a.editcateProp").bind("click",function(){
    ...
    updatePropDialog = new xDialog("/vst_admin/biz/categoryProp/showCategoryProp.do",
...
$("a.editCatePropFlag").bind("click",function(){
	  ...
	  var url = "/vst_admin/biz/categoryProp/editFlag.do?propId="+propId+"&cancelFlag="+cancelFlag+"&newDate="+new Date();
