...
$("#addButton").bind("click",function(){
	...
	//打开选择属性池列表
	selectBranchBizPropPoolDialog = new xDialog("/vst_admin/biz/category/selectBizPropPoolList.do"+ param,{},{title:"选择属性",iframe:true,width:"1000",height:"auto"});
...
$("a.editProp").bind("click",function(){
    ...
    var url = "/vst_admin/biz/branchProp/showBranchProp.do";
...
$("a.editBranchPropFlag").bind("click",function(){
   ...
   var url = "/vst_admin/biz/branchProp/editFlag.do?propId="+propId+"&cancelFlag="+cancelFlag+"&newDate="+new Date();
