...
$(function(){
	...
	$("#new_button").bind("click",function(){
		addSuggestionDialog = new xDialog("/vst_admin/biz/suggestion/showAddSuggestion.do",{},{title:"基础信息",width:800,height:700});
		return;
	});
	...
	$("a.editSuggestion").bind("click",function(){
	    ...
	    var url = "/vst_admin/biz/suggestion/showAddSuggestion.do";
	...
	$("a.addGroup").bind("click",function(){
		var suggId = $(this).attr("data");
		var url = "/vst_admin/biz/suggestionGroup/showAddGroup.do";
	...
	$("a.groupList").bind("click",function(){
		var suggId = $(this).attr("data");
	    var url = "/vst_admin/biz/suggestionGroup/findGroupList.do";
	...
	$("a.editDetail").bind("click",function(){
	    ...
	    var url = "/vst_admin/biz/suggestionDetail/findDetailList.do";
	...
	$("a.previewDetail").bind("click",function(){
		...
		window.previewDetailDialog = new xDialog(url,{"suggCode":suggCode,"reqDataFrom":""}, {title:"预览",width:800,height:1000});
		return false;
	});
