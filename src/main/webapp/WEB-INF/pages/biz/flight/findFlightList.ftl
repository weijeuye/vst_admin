...
<html>
  ...
  <div class="iframe_content">   
    <div class="p_box">
        <form method="post" action='/vst_admin/biz/flight/findFlightList.do' id="searchForm">
            <table class="s_table">
                <tbody>
                    <tr>
                        ...
                        <td class="w18">
                            <input type="text" class="searchInput" id="airlineString" name="airlineString" value="${bizFlight.airlineString!''}" errorele="searchValidate"/>
        ...
        <tbody>
            ...
            <tr>
                ...
                <td class="oper">
                    ...
                    <a  href="javascript:void(0);" class="showLogDialog" param='objectId=${bizFlight.flightId}&objectType=BIZ_FLIGHT_OPER&sysName=VST'>查看操作日志</a>
                  </td>
                </tr>
            </#list>
        </tbody>
    ...
    <script>
        ...
        $("#new_button").on('click',function(){
            var url = "/vst_admin/biz/flight/showAddFlight.do";
            addDialog = new xDialog(url, {}, {title:"新增航班信息",width:900});
        });
        
        //修改
        $("a.editProp").on('click',function(){
            var flightId = $(this).attr("data");
            var url = "/vst_admin/biz/flight/showUpdateFlight.do";
            updateDialog = new xDialog(url,{"flightId":flightId}, {title:"编辑航班信息",width:900});
        });
        ...
        $("a.cancelProp").on("click",function(){
            ...
            if(confirm(msg)){    
                $.ajax({
                    url : "/vst_admin/biz/flight/setCancelFlag.do",
                    type : "post",
