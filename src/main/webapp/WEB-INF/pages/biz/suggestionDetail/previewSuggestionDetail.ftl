...
$("#cancelButton").bind("click",function(){
	if ($("#groupId").val()=="")
		addGroupDialog && addGroupDialog.close();
	else
		updateGroupDialog && updateGroupDialog.close();
		
	previewDetailDialog && previewDetailDialog.close();
});
...
//		console.log ("result=" + result );
 ...
 //# sourceURL=previewSuggestionDetail.ftl
</script>
