  ...
  <div class="iframe_content">   
      ...
      <table class="p_table table_center">
        ...
        <tbody>
            ...
            <tr>
                ...
                <td class="oper">
                    <a href="javascript:void(0);" class="editStopProp" stopId="${stop.stopId!''}" trainId="${trainId}" trainNo="${trainNo}">编辑</a>
                    <#if stop.cancelFlag == "Y"> 
    ...
    <script>
        ...
        $("#add_button").on('click',function(){
            var url = "/vst_admin/biz/trainStop/showAddTrainStop.do";
            addDialog = new xDialog(url, {"trainId":$(this).attr("trainId"), "trainNo":$(this).attr("trainNo")}, {title:"添加经停车站",width:800});
        });
        
        //修改
        $("a.editStopProp").on('click',function(){
            var url = "/vst_admin/biz/trainStop/showUpdateTrainStop.do";
        ...
        $("a.cancelProp").on("click",function(){
            ...
            if(confirm(msg)){    
                $.ajax({
                    url : "/vst_admin/biz/trainStop/setCancelFlag.do",
                    type : "post",
