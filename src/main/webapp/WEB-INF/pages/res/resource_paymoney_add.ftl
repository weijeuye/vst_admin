        ...
        <dl class="clearfix">
            ...
            <dd>
              	<div class="form-group col mr10">
                    <input name="amountStr" id="amountStr" type="text" class="form-control w200 JS_amountStr"
            ...
            <dd>
                <div class="form-group col mr10">
                    <textarea id="memo" name="memo"  maxlength=300 style="width:300px; height:100px;" class="form-control w200 JS_memo"/></textarea>
                </div>
            ...
            if (validateAdd.getIsValidate()) {
				...
				/* 	 var lentrim=$.trim(payPerson).length;
                    ...
                    determineCallback: function() {
                        $.ajax({
                        url: "/vst_admin/goods/recontrol/addResourceControlPayment.do",
                        type: "POST",
                        cache: false,
                        dataType:"json",
                        async : false,
