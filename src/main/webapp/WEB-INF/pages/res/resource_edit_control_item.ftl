...
<div class="main mt10">
    <form id="saveButton">
        <dl class="clearfix">
            ...
            <dd>
                <div class="form-group">
                  <#if policyItem.itemControlClass == "add">
                     <div class="col w90">
                        <label>
                            <input name="showItemControlClass" type="radio" value="add" checked="checked" disabled="disabled" data-validate="{required:true}"/>
                            追加
                        </label>
                    </div>
                    <div class="col w90">
                        <label>
                            <input name="showItemControlClass" type="radio" value="subtract" disabled="disabled" data-validate="{required:true}"/>
                            减少
                        </label>
                    </div>
                  <#else>
                     <div class="col w90">
                        <label>
                            <input name="showItemControlClass" type="radio" value="add"  disabled="disabled" data-validate="{required:true}"/>
                            追加
                        </label>
                    </div>
                    <div class="col w90">
                        <label>
                            <input name="showItemControlClass" type="radio" value="subtract" checked="checked" disabled="disabled" data-validate="{required:true}"/>
                            减少
                        </label>
                    </div>
                  </#if>
            ...
            <dd>
                <div class="JS_radio_switch_group form-group w530">
                    <div class="col w265 JS_radio_switch_box">
                        <span class="">
                        <#if policyItem.itemControlType == "amount">
	                        <label>
	                        ...
	                        <span class="form-group">
	                        	<input id="amounta"  name="quantity" type="text" class="form-control w110 JS_radio_disabled" value="${policyItem.quantity}" data-validate="{required:true}"/>
                        	</span>
                        <#else>
                          	 <label>
	                            <input name="showItemControlType" class="JS_radio_switch" type="radio" disabled="disabled" value="amount"
                    ...
                    <div class="col w265 JS_radio_switch_box">
                        <span class="">
                        <#if policyItem.itemControlType == "inventory">
	                        <label>
	                        ...
	                        <span class="form-group">
	                       		 <input id="amountb" name="quantity" type="text" class="form-control w110 JS_radio_disabled" value="${policyItem.quantity}" data-validate="{required:true}"/>
                       		</span>
                        <#else>
                        <label>
		...
		<input type="hidden" class="JS_autocomplete_pm_hidden" id="precontrolPolicyId" value="${policyItem.precontrolPolicyId}" name="precontrolPolicyId"/>
		<input type="hidden" class="JS_autocomplete_pm_hidden" id="itemControlType" value="${policyItem.itemControlType}" name="itemControlType"/>
		<input type="hidden" class="JS_autocomplete_pm_hidden" id="itemControlClass" value="${policyItem.itemControlClass}" name="itemControlClass"/>
		<input type="hidden" class="JS_autocomplete_pm_hidden" id="policyItemId" value="${policyItem.policyItemId}" name="policyItemId"/>
        </dl>
        ...
        $document.on("click", ".JS_item_btn_save", function () {
            ...
            if (validateAdd.getIsValidate()) {
                    ...
                    determineCallback: function() {
                        $.ajax({
                        url: "/vst_admin/goods/recontrol/editResourceControlItem.do",
                        type: "POST",
                        cache: false,
                        dataType:"json",
                        async : false,
