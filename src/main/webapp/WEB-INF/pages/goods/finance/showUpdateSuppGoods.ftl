<div class="iframe_content mt10">
    ...
    <form action="/vst_admin/finance/goods/upadteSuppGoods.do" method="post" id="dataForm">
                ...
                <table class="e_table form-inline">
                    ...
                    <tr>
                        ...
                        <td><label><input type="text" class="w35" style="width:500px" name="goodsName" id="goodsName"
                                          required="true" maxlength="70" value="${suppGoods.goodsName}"></label>
                    ...
                    <tr>
                        ...
                        <td>
                            <input type="text" class="w350 searchInput" name="contentManagerName"
                                   id="contentManagerName" value="${contentManagerName}" required=true>
                    ...
                    <tr>
                        ...
                        <td>
                            ...
                            <label id="contractNameAdd"> <#if suppGoods!=null && suppGoods.suppContract!=null>${suppGoods.suppContract.contractName}</#if></label>
                            <input type="hidden" name="suppContract.contractName"
                                   <#if suppGoods!=null && suppGoods.suppContract!=null>value="${suppGoods.suppContract.contractName}"</#if>>
                    ...
                    <tr>
                        ...
                        <td>
                            <input type="text" name="minQuantity" required=true value="${suppGoods.minQuantity!''}">
                        </td>
                    </tr>
                    <tr>
                        <td class="e_label"><i class="cc1">*</i>最大订购数量：</td>
                        <td>
                            <input type="text" name="maxQuantity" required=true value="${suppGoods.maxQuantity!''}">
                        </td>
                    </tr>
                    <tr>
                        <td class="e_label"><i class="cc1">*</i>销售价：</td>
                        <td>
                            <input type="text" name="salesPrice" required=true value="${salesPrice!''}">
                        </td>
                    </tr>
                    <tr>
    ...
    $(function(){
        ...
        $("#save").click(function(){
            ...
            $.confirm(msg,function(){
                $.ajax({
                    url : "/vst_admin/finance/goods/updateSuppGoods.do",
                    type : "post",
