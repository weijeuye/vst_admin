...
<script>
	...
	$("#reservationLimitButton").click(function(){
		...
		var url =  <#if comOrderRequired??>"/vst_admin/ticket/goods/reservationLimit/updateReservationLimit.do"<#else>"/vst_admin/ticket/goods/reservationLimit/addReservationLimit.do"</#if>;
		$.ajax({
			url : url,
