		 ...
		 <input type="hidden" name="supplierId" value="<#if suppGoods.suppSupplier??>${suppGoods.suppSupplier.supplierId}</#if>">
			...
			<table   class="e_table form-inline" style="width:900px;" goodsId="">
             ...
             <tbody>
                ...
                <tr>
                    ...
                    <input type="radio" class="typeSelect"  name="timePriceList[0].stockType" checked="checked" value="INQUIRE_NO_STOCK"/>现询-未知库存</label></td>
               		<td width="450"></td>
                </tr>
                <tr>
                    <td class="e_label"><label class="radio" style="padding-right:21px;">
                    	<input type="radio" class="typeSelect"  name="timePriceList[0].stockType" value="INQUIRE_WITH_STOCK"/>现询库存</label></td>
                	 <td></td>
                </tr>
                <tr  id="withStockTr">
                ...
                <tr id="oversellFlagTr_2">
                	...
                	<td>
                	<select class="w10" name="timePriceList[0].oversellFlag"  disabled=disabled>
                ...
                <tr>
                    ...
                    <input type="radio" class="typeSelect"   name="timePriceList[0].stockType" value="CONTROL"/>确定日库存</label></td>
                	<td></td>
                </tr>
                <tr>
                    <td class="e_label">日库存量：</td>
		    ...
		    <table class="e_table form-inline" goodsId="">
             <tbody>
                 ...
                 <tr >
                    <td class="e_label">是否强制预授权：</td>
                     <td>
	                    <select class="w10" name="timePriceList[0].bookLimitType" id="bookLimitType">
...
<script>
	...
	$("#timePriceSaveButton").click(function(){
	    if($("input[type=radio][class=good]:checked").attr("dataFlag")=="Y"){
	      alert("对接商品不可编辑时间价格表");
	      return;
	    }
	   ...
	   $(".adult,.child").each(function(){
		...
		$.ajax({
			url : "/vst_admin/goods/traffic/timePrice/editGoodsTimePrice.do",
		...
		$(".typeSelect").bind("click",function(){
     		...
     		if((that.attr("checked")=="checked")&&that.val()=="INQUIRE_WITH_STOCK"){
     			...
     			$("#oversellFlagTr_2").find("select[name='timePriceList[0].oversellFlag']").removeAttr("disabled");
     			$("#oversellFlagTr_3").find("select[name='timePriceList[0].oversellFlag']").attr("disabled","disabled");
     		}else {
     			$("#withStockTr").find("input[type='text']").attr("disabled","disabled");
     			$("#oversellFlagTr_2").find("select[name='timePriceList[0].oversellFlag']").attr("disabled","disabled");
     			$("#oversellFlagTr_3").find("select[name='timePriceList[0].oversellFlag']").removeAttr("disabled");
     		}
     	});
</script>
