<form action="/vst_admin/goods/goods/addSuppGoods.do" method="post" id="dataForm" class="goodsForm" style="overflow-y: auto;height:500px;">
        <table class="p_table form-inline">
            <tbody>
                ...
                <tr>
					...
					<td colspan=2>
                        <input type="radio" name="grossMarginType" value="FIXED" >固定金额
                        <input type="radio" name="grossMarginType" value="PERCENT" checked="checked">百分比
                        <input type="text" name="grossMarginName" id="grossMarginName" style="margin-left:20px;width:50px;margin-right:5px;">元/%
...
<script>
		...
		$("#save").bind("click",function(){
				...
				$.confirm(msg,function(){
					...
					$.ajax({
						url : "/vst_admin/goods/grossMargin/addSuppGoodsGrossMargin.do",
						type : "post",
