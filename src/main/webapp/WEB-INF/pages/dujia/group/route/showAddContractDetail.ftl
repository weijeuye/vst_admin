        ...
        <table class="p_table form-inline">
            <tbody>
                ...
                <tr>
		            ...
		            <td colspan="3">
		            	<textarea  name="detailName"  rows="3"  maxlength="1500"  style="width:300px" required=true>${prodContractDetail.detailName!''}</textarea>
		            </td>
		        </tr>
		        <tr>
                ...
                <tr>
                  ...
                  <tr>
		            ...
		            <td colspan="3">
		            	<textarea  name="other"  rows="3"  maxlength="250" style="width:300px"><#if prodContractDetail.detailType == 'RECOMMEND'><#if prodContractDetail.other?length gt 0>${prodContractDetail.other!''}<#else><#if categoryId==15>特别说明：自费项目均是建议性项目，客人应本着“自愿自费”的原则酌情参加，如以上项目参加人数不足时，则可能无法成行或费用做相应调整。<#else>在行程游览过程中，导游可能会向您推荐如下自费项目，您可以根据您的自身情况，自愿选择参加自己喜欢的自费项目。</#if></#if><#else><#if prodContractDetail.other?length gt 0>${prodContractDetail.other!''}<#else>购物自愿，敬请保留相关购物凭证。</#if></#if></textarea>
		            </td>
		        </tr>
            </tbody>
        </table>
...
$("#saveButton").bind("click",function(){
   ...
   if(refreshSensitiveWord($("input[type='text'],textarea"))){
	...
	$.confirm(msg,function(){
		$.ajax({
			url : "/vst_admin/dujia/group/route/contractDetail/saveProdContractDetail.do",
			type : "post",
			dataType:"json",
			async: false,
