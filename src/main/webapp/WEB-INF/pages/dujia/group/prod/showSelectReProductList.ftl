...
<div class="p_box box_info">
	<form method="post"  id="searchForm">
        ...
        <table class="s_table" style="width:1120px;">
            <tbody>
                <tr>
                    <td class="s_label" style="width:55px;">产品ID：</td>
                    <td class="w18" style="width:100px;"><input type="text" style="width:100px;" name="productId" value="${productId!''}" number="true" ></td>
                    <td class="s_label" style="width:70px;">产品名称：</td>
                    <td class="w18" style="width:100px;"><input type="text" style="width:100px;" name="productName" value="${productName!''}"></td>
                    <td class="s_label" style="width:70px;">产品经理：</td>
                    ...
                    <td class="s_label"style="width:70px;">行程天数：</td>
                    <td class="w18" style="width:100px;">
	                    <select id="routeDay">
