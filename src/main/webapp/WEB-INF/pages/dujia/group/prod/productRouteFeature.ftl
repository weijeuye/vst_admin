...
<#assign picheight={"ONE":"432","ONE-TITLE":"432","TWO":"353","THREE":"231","CUSTOM":"432"}>
...
<div class="everything">
    ...
    <div class="pf-header">
        ...
        <div class="pf-tabs clearfix"  <#if hasHead=="false">style="display:none;"</#if>>
            ...
            <a href="javascript:;" id="showOldFeature">旧版本</a>
        </div>
        ...
        <div class="pf-func clearfix">
            ...
            <div class="pull-right">
            	<#if (categoryId==15 || categoryId==16)&&productType!="FOREIGNLINE">
        ...
        <#if (categoryId==15 || categoryId==16)&&productType!="FOREIGNLINE">
    		<div id ='richText'class="pf-richText" featproptype="RICH_TEXT">
	    		...
	    		<div class="pf-richContent">
					...
					placeholder="富文本内容为可选项，可根据产品特色添加富文本内容，输入不得大于600px"><#if featPropValue??>${featPropValue}<#else><span  class="richtext-span">富文本内容为可选项，可根据产品特色添加富文本内容，输入不得大于600px</span></#if>
			   		</textarea>
		   		</div>
	   		</div>
	        ...
	        <div class="pf-movable pf-movable-small-title" featPropType="SMALL_TITLE" divIndex="div${ProdRouteFeature_index}">
	            ...
	            <div class="pf-content">
	                <span class="form-group">
	                    ...
	                    <input type="text" name="smallTitle" value="" maxlength="100" class="input-text pf-title-text" placeholder="这是小标题，100个汉字以内，一个汉字含一个字符，可以字符汉字混合展示。"
	                           data-validate="{required:请输入小标题！若不需要，可删除。}">
	                </span>
	            </div>
	            <div class="pf-btn-box">
	                <a class="btn JS_movable_del">删除</a>
...
<div class="template">
    ...
    <!--正文模板 结束-->
    <#include "/dujia/group/prod/addPicture.ftl"/>
    <!--预览 开始-->
    <div class="pf-view-template JS_view_template">
    <div style="width: 1080px;margin: 0 auto;font-family:'Microsoft Yahei',sans-serif;">
    </div>
    </div>
    <!--预览 结束-->
  ...
  //关联产品特色                               
	...
	if($("#editFlag").val() != "false"){
        ...
        $document.on("click", ".JS_btn_save", function () {
			...
			if(productType!="FOREIGNLINE" && (categoryId==15 || categoryId==16)){
        		...
        		$(".featureRichText").text(window.frames[0].frames.frameElement.contentDocument.body.innerText);
            }
        ...
        $document.on("click", "#showOldFeature", function () {
			...
			$form.attr("action","/vst_admin/dujia/group/product/showProductRouteFeatureOld.do");
			$form.submit();
        });
      ...
      function submitFeature() {
        ...
        function submitForm(){
        	setFeatureHiddenDiv();
        	$.ajax({
				url : "/vst_admin/dujia/group/product/updateProductFeature.do",
				type : "post",
				dataType : 'json',
		    	...
		    	if(propType=="BIG_TITLE"){
		    		...
		    		if(dataObj.templateType=="ONE"){
		    			...
		    			var imgHtml='<div style="font-size: 0; margin-bottom: 20px;">'+
							            ...
							            '</span>'+
							            '<span style="width: 530px;height: 353px;margin:0;display: inline-block;">'+
		    			...
		    			var imgHtml='<div style="font-size: 0; margin-bottom: 20px;">'+
							            ...
							            '</span>'+
							            '<span style="width: 347px;height: 231px;margin:0;display: inline-block;">'+
...
//        }
	if($("#editFlag").val() != "false"){	
        ...
        function choosePicture($this,single){
            ...
            var url="/photo-back/photo/photo/imgPlugIn.do?relationId="+$("#productId").val()+"&relationAuthor="+$("#userName").val()+"&relationType="+$("#categoryId").val();//&imgLimitType=LIMIT_3_2_3L
    ...
    function copyProdFeature(copyProductId) {
    	...
    	destoryDialog(copyFeatureDialog);
        $.ajax({
            url: "/vst_admin/dujia/group/product/copyProdFeature.do",
            type: "post",
            dataType: 'json',
            data: {
    ...
    function copyProdRichText(copyProductId) {
    	destoryDialog(copyFeatureDialog);
        $.ajax({
            url: "/vst_admin/dujia/group/product/copyProdRichText.do",
            type: "post",
            dataType: 'json',
            data: {
                oldProductId: $("input[name=\"productId\"]").val(),
