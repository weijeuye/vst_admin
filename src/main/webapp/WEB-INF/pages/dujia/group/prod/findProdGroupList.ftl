...
<script>
	...
	$("#select").click(function(){
		...
		productSelectDialog = new xDialog("/vst_admin/dujia/group/product/showSelectReProductList.do",{prodProductId:'${prodProductId}',categoryId:'${categoryId}'},{title:"选择关联产品",width:"1150",height:"350"});
	});
