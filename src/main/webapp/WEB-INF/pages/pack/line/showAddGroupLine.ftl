			                    ...
			                    <tr>
			             		 ...
			             		 <tr id="hotelComb1" style="display: none">
			             			...
			             			<td style="text-align: left;" id="adultTD">
			             				...
			             				<#else>
			             				    ${prodPackageGroupLine.adult}
											<input type="hidden" name="prodPackageGroupLine.adult" value="${prodPackageGroupLine.adult}">
			             				</#if>
			             		 ...
			             		 <tr id="hotelComb2" style="display: none">
			             			...
			             			<td style="text-align: left;" id="childTD">
			             				...
			             				<#else>
			             				    ${prodPackageGroupLine.child}
                                            <input type="hidden" name="prodPackageGroupLine.child" value="${prodPackageGroupLine.child}">
			             				</#if>
			             		...
			             		<tr>
			             			<td colspan="2" style="text-align: left;">
				                    	<label>
				                    		<textarea class="w35 textWidth"  name="prodPackageGroupLine.remark" id="remark" maxlength="100" style="width:500px; height:80px"></textarea>
				                    	</label>
				                    </td>	
			                   </tr>
		             		</tbody>
