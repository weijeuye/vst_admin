...
_extend(KNode, {
	...
	before : function(expr) {
		this.each(function() {
			this.parentNode && this.parentNode.insertBefore(_get(expr), this);
		});
		return this;
	},
	after : function(expr) {
	...
	create : function() {
		...
		K.each(self.items, function(i, name) {
			if (name == '|') {
				...
				// 分组名称显示
				htmlList.push('<span class="ke-inline-block joyu-ke-bold">' + name.groupTitle + ':</span>');
			} else {
			    if (name == "joyuImage") {
