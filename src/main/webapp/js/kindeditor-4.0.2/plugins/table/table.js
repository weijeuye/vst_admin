	...
	self.plugin.table = {
		...
		prop : function(isInsert) {
			var html = [
				...
				lang.padding + ' <input type="text" id="kePadding" class="ke-input-text ke-input-number" name="padding" value="10" maxlength="4" disabled="disabled" /> &nbsp; ',
				lang.spacing + ' <input type="text" class="ke-input-text ke-input-number" name="spacing" value="" maxlength="4" disabled="disabled" />',
				'</div>',
				//align
				'<div class="ke-dialog-row">',
				...
				lang.borderWidth + ' <input type="text" id="keBorder" class="ke-input-text ke-input-number" name="border" value="" maxlength="4" disabled="disabled" /> &nbsp; ',
			...
			paddingBox = K('[name="padding"]', div).val(10),
