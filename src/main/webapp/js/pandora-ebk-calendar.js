...
* Description: ebkPandora-calendar
*
* Update History:
...
*
*********************************************************************************/
(function (global, $, ebkPandora, undefined) {
    "use strict"  // 严格模式

    if (ebkPandora.calendar) {
        return;
    }
    ...
    Calendar.prototype = {
        ...
        */
        ...
        render: function (e) {
            ...
            // 一个很挫的CASE
            if( e ){
                $calendarDOM = $(e.currentTarget).parents(".ui-calendar-mini");
            }
            this.warp.html("");
            ...
            if (typeof options.completeCallback === "function") {
                options.completeCallback($calendarDOM);
            }
        },
        ...
        */
        ...
        monthChangeEvent: function () {
            ...
            this.warp.find("span.month-prev").bind("click", function (e) {
                that.changeMonth(-1, e);
            });

            this.warp.find("span.month-next").bind("click", function (e) {
                that.changeMonth(1, e);
            });
        },
        ...
        selectDate: function () {
            ...
            this.warp.find("td div[class^=caldate]").click(function (e) {
                ...
                if (!that.options.autoRender) {//非自动渲染 在选择完日期后关闭日历
                    ...
                    if (typeof that.options.selectDateCallback === "function") {
                        that.options.selectDateCallback(that, e);
                    }
                }else{
                    if (that.options.allowMutiSelected) {
                        ...
                        if($box.hasClass("calSelected")){
                            ...
                            if (typeof that.options.cancelDateCallback === "function") {
                                that.options.cancelDateCallback(that, e);
                            }
                        }
                        else{
    ...
    // 前端框架 ebkPandora 对象 
    $.fn.calendar = ebkPandora.calendar = Factory;

    global.ebkPandora = ebkPandora;
}(this, jQuery, this.ebkPandora || {}));
